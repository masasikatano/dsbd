...
欠測しても表の行は残し「データなし」と出します。クレジットスプレッドは HY-OAS（FRED）を出します。FRA-OIS は無料ソースに安定シリーズがないため載せていません。CPI・米失業率・ISM製造業 PMI・日銀短観の販売価格見通しなどのマクロ指標は「7 マクロ指標（月次）」セクションに表示し、前月比・前年比を出します。
